...
from lib.dito_bot import DiToBot
...
if __name__ == "__main__":
    ...
    # create bot instance
    dito_bot = DiToBot(args.token, args.user, args.host, args.port)
    dito_bot.task_id = args.task_id
    dito_bot.waiting_room = args.waiting_room
