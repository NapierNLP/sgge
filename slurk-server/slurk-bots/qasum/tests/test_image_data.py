...
class TestImageData(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.not_shuffled.get_item_pairs("mock_room")
        self.not_shuffled.get_item_pairs("other_mock_room")
        self.not_shuffled.get_item_pairs("another_mock_room")
        # shuffled image data access
        self.shuffled = ImageData(path="", n=3, shuffle=True, seed=24)
        self.shuffled.get_item_pairs("shuffled_mock_room")
    ...
    def test_shuffled_reproducible(self):
        ...
        self.other_shuffled.get_item_pairs("other_shuffled_mock_room")
    ...
    def test_shuffled_uniform_distribution(self):
        ...
        for i in range(200):
            self.shuffled.get_item_pairs(str(i))
